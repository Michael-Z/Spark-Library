...
- (void) setUpLayers {
	...
	topPage.backgroundColor = [[UIColor colorWithRed:1 green:0.98 blue:0.941 alpha:1] CGColor];
	...
	topPageReverse.backgroundColor = [[UIColor colorWithRed:1 green:0.98 blue:0.941 alpha:1] CGColor];
	...
	topPageReverseOverlay.backgroundColor = [[[UIColor colorWithRed:1 green:0.98 blue:0.941 alpha:1] colorWithAlphaComponent:0.8] CGColor];
	...
	bottomPage.backgroundColor = [[UIColor colorWithRed:1 green:0.98 blue:0.941 alpha:1] CGColor];
...
- (void) reloadData {
	...
	self.currentPageIndex = numberOfPages-1; //hegab
}
